...
# Integrate from 0 to actual abatement amount for each sector to find total cost:

sectorA_totalcost3B <- 1263.69
# Integrate from 0 to 82.85692
# Total cost to Sector A under cap and trade is $1263.69

sectorB_totalcost3B <- 3637.89
# Total cost to Sector B under cap and trade is $3637.89

sectorC_totalcost3B <- 651.284
# Total cost to Sector C under cap and trade is $651.284
...
countryX_totalcost3B <- sectorA_totalcost3B+sectorB_totalcost3B+sectorC_totalcost3C
# Total cost of meeting target under tax for Country X is $6858.95
...
# Sector A needs 2.85692 permits
# Sector B needs 50.1242 permits
# Sector C can sell 55.18452 permits

sectorA_permit <- (tax*17)
# Sector A will pay $665.51 for 17 permits

sector_B_permit <- (tax*51)
# Sector B will receive $1996.52 for 51 permits sold

sectorC_permit <- (tax*35)
# Sector C will pay $1370.16 for 35 permits sold
...
# Total cost to country X is $39.15
...
tax4 <- ((0.08410515 * 600) + 4.567783)
# New tax w/ Sector D is $55.03
...
# Sector A will abate 110.39 tons
# Sector A can sell 11 credits


# Sector B
sectorB_abatement4 <- ((tax4 - 9.3177) / 0.1987)
# Sector B will abate 230.06 tons
# Sector B can sell 131 credits


# Sector C
sectorC_abatement4 <- ((tax4 + 11.6550) / 0.7838)
# Sector C will abate 85.08 tons 
# Sector C needs 

# Sector D
sectorD_abatement4 <- ((tax4 -9.6875)/0.2599)
# Sector D will abate 174.46 tons
# Sector D needs 126 credits
