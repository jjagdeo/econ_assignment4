...
curve(equation_a_supply, from = 0, to = 200, xlim = c(0,100), xaxs = "i", ylim = c(-10,100), yaxs = "i")
...
curve(equation_b_supply, from = 0, to = 200, add = TRUE, col = "blue")
...
curve(equation_c_supply, from = 0, to = 200, add = TRUE, col = "green")
...
curve(equation_d_supply, from = 0, to = 200, add = TRUE, col = "purple")
...
curve(equation_a_demand, from = 0, to = 200, xlim = c(0,100), xaxs = "i", ylim = c(0,200), yaxs = "i")
...
curve(equation_b_demand, from = 0, to = 200, add = TRUE, col = "blue")
...
curve(equation_c_demand, from = 0, to = 200, add = TRUE, col = "green")
...
curve(equation_d_demand, from = 0, to = 200, add = TRUE, col = "purple")
...
# Aggergate equations horizontally 
